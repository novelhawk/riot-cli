use crate::val_api::models::{UnofficalApiResponse, ValorantVersionResponse, SkinDetails};
...
pub async fn get_client_version() -> String {
    ...
    format!("{}-shipping-{}-{}", version.branch, version.build_version, version.version.split('.').nth(3).unwrap())
}
